      ...
      <div className="container-artful py-10">
        ...
        <div className="flex gap-10">
          ...
          <div className="flex-1 min-w-0">
            {items === null ? (
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-10">{[...Array(6)].map((_, i) => <ProductSkeleton key={i} />)}</div>
            ) : items.length === 0 ? (
              ...
              <>
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-10" data-testid="product-catalog-grid">
